 ...
 */ (function(global, factory) {
    "use strict";
    if ((typeof module === "undefined" ? "undefined" : _type_of(module)) === "object" && _type_of(module.exports) === "object") {
...
// Pass this if window is not defined yet
})(typeof window !== "undefined" ? window : void 0, function(window1, noGlobal) {
    ...
    function toType(obj) {
        ...
        return (typeof obj === "undefined" ? "undefined" : _type_of(obj)) === "object" || typeof obj === "function" ? class2type[toString.call(obj)] || "object" : typeof obj === "undefined" ? "undefined" : _type_of(obj);
    }
    ...
    jQuery.extend = jQuery.fn.extend = function() {
        ...
        if ((typeof target === "undefined" ? "undefined" : _type_of(target)) !== "object" && !isFunction(target)) {
            target = {};
        }
    ...
    rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init = jQuery.fn.init = function init(selector, context, root) {
        ...
        if (typeof selector === "string") {
            ...
            if (match && (match[1] || !context)) {
                // HANDLE: $(html) -> $(array)
                if (match[1]) {
                    context = _instanceof(context, jQuery) ? context[0] : context;
 ...
 */ jQuery.Callbacks = function(options) {
                    ...
                    function resolve(depth, deferred, handler, special) {
                        return function() {
                            var that = this, args = arguments, mightThrow = function mightThrow() {
                                ...
                                ((typeof returned === "undefined" ? "undefined" : _type_of(returned)) === "object" || typeof returned === "function") && returned.then;
    ...
    function on(elem, types, selector, data, fn, one) {
        ...
        if ((typeof types === "undefined" ? "undefined" : _type_of(types)) === "object") {
 ...
 */ jQuery.event = {
    ...
    jQuery.Event = function(src, props) {
        ...
        if (!_instanceof(this, jQuery.Event)) {
    ...
    jQuery.speed = function(speed, easing, fn) {
        var opt = speed && (typeof speed === "undefined" ? "undefined" : _type_of(speed)) === "object" ? jQuery.extend({}, speed) : {
    ...
    jQuery.fn.extend({
        ...
        toggleClass: function toggleClass(value, stateVal) {
            var type = typeof value === "undefined" ? "undefined" : _type_of(value), isValidValue = type === "string" || Array.isArray(value);
    ...
    jQuery.extend(jQuery.event, {
        trigger: function trigger(event, data, elem, onlyHandlers) {
            ...
            event = event[jQuery.expando] ? event : new jQuery.Event(type, (typeof event === "undefined" ? "undefined" : _type_of(event)) === "object" && event);
        ...
        if (Array.isArray(obj)) {
            ...
            jQuery.each(obj, function(i, v) {
                if (traditional || rbracket.test(prefix)) {
                    ...
                    buildParams(prefix + "[" + ((typeof v === "undefined" ? "undefined" : _type_of(v)) === "object" && v != null ? i : "") + "]", v, traditional, add);
                }
            });
    ...
    jQuery.extend({
		...
		*/ accepts: {
        ...
        ajax: function ajax(url, options) {
            ...
            if ((typeof url === "undefined" ? "undefined" : _type_of(url)) === "object") {
                options = url;
                url = undefined;
            }
 ...
 */ jQuery.fn.load = function(url, params, callback) {
        ...
        } else if (params && (typeof params === "undefined" ? "undefined" : _type_of(params)) === "object") {
            type = "POST";
        }
